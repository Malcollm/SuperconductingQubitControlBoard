...
class BlochSphereGUI:
    ...
    def _build_controls(self):
        axcolor = "whitesmoke"
        ax_i = self.fig.add_axes([0.15, 0.20, 0.7, 0.03], facecolor=axcolor)
        ax_q = self.fig.add_axes([0.15, 0.15, 0.7, 0.03], facecolor=axcolor)
        ax_dur = self.fig.add_axes([0.15, 0.10, 0.7, 0.03], facecolor=axcolor)
